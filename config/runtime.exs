...
#
#     PHX_SERVER=true bin/aper_desk start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :aper_desk, AperDeskWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :aper_desk, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
if config_env() == :prod do
  ...
  config :aper_desk, AperDesk.Accounts.Guardian, secret_key: guardian_secret
  ...
  config :aper_desk, :storage,
    ...
    public_base_url: System.fetch_env!("STORAGE_PUBLIC_BASE_URL")
  ...
  config :aper_desk, :stripe, enabled?: System.get_env("STRIPE_SECRET_KEY") != nil
  config :stripity_stripe, api_key: System.get_env("STRIPE_SECRET_KEY")

  config :aper_desk, AperDesk.Mailer,
